      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.modalCard, isDarkMode && styles.darkCard]}>
            ...
            <Text style={[styles.modalTitle, isDarkMode && styles.darkText]}>My Orders</Text>
            
            <View style={[styles.orderItemCard, isDarkMode && styles.darkInput]}>
              <View style={styles.orderHeader}>
                <Text style={styles.orderId}>#NOV-842109</Text>
                <View style={styles.statusBadge}>
                  <Text style={styles.statusText}>Processing</Text>
                </View>
              </View>
              <Text style={[styles.orderDetailsText, isDarkMode && styles.darkMutedText]}>
                1x Wireless Headphones
              </Text>
              <Text style={styles.orderPriceText}>₱2,499</Text>
            </View>
