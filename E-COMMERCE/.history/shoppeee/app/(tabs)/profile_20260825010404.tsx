...
const styles = StyleSheet.create({
  ...
  profileCard: { flexDirection: "row", alignItems: "center", backgroundColor: "#FFFFFF", borderRadius: 16, padding: 16 },
  ...
  email: { fontSize: 12, color: "#868E96", marginTop: 2 },
  addressRow: { flexDirection: "row", alignItems: "center", marginTop: 4 },
  addressText: { fontSize: 11, color: "#868E96", marginLeft: 3, flex: 1 },
  statsRow: { flexDirection: "row", marginTop: 12, gap: 12 },
  statBox: { flex: 1, backgroundColor: "#FFFFFF", borderRadius: 14, paddingVertical: 14, alignItems: "center" },
  statValue: { fontSize: 18, fontWeight: "800", color: "#FF6B35" },
  statLabel: { fontSize: 11, color: "#868E96", marginTop: 2 },
  sectionTitle: { fontSize: 13, fontWeight: "700", color: "#868E96", marginTop: 22, marginBottom: 8, textTransform: "uppercase" },
  card: { backgroundColor: "#FFFFFF", borderRadius: 14, overflow: "hidden" },
  row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 14, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: "#F1F3F5" },
  darkRow: { borderBottomColor: "#343A40" },
  rowPressed: { backgroundColor: "#F8F9FA" },
  rowLeft: { flexDirection: "row", alignItems: "center" },
  rowIcon: { width: 30, height: 30, borderRadius: 8, backgroundColor: "#FFF1E9", alignItems: "center", justifyContent: "center", marginRight: 10 },
  rowLabel: { fontSize: 14, color: "#212529", fontWeight: "500" },
  logoutButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", marginTop: 26, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: "#FFC9C9", backgroundColor: "#FFF5F5" },
  logoutText: { marginLeft: 8, color: "#E03131", fontWeight: "700" },
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.45)", alignItems: "center", justifyContent: "center", padding: 20 },
  modalCard: { backgroundColor: "#FFFFFF", borderRadius: 18, padding: 24, alignItems: "center", width: "100%" },
  ordersModalCard: { maxHeight: "80%", alignItems: "stretch" },
  modalHeaderRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: "100%" },
  modalTitle: { fontSize: 18, fontWeight: "800", color: "#212529", marginTop: 10, marginBottom: 8 },
  modalBody: { fontSize: 13, color: "#495057", textAlign: "center", marginTop: 10, lineHeight: 19 },
  confirmLogoutButton: { marginTop: 20, backgroundColor: "#E03131", borderRadius: 10, paddingVertical: 12, paddingHorizontal: 32, width: "100%", alignItems: "center" },
  confirmLogoutText: { color: "#FFFFFF", fontWeight: "700", fontSize: 15 },
  avatarPickerWrapper: { position: "relative", marginVertical: 14, alignSelf: "center" },
  modalAvatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: "#E9ECEF" },
  avatarCameraBadge: { position: "absolute", bottom: 0, right: 0, backgroundColor: "#FF6B35", width: 26, height: 26, borderRadius: 13, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "#FFFFFF" },
  input: { width: "100%", borderWidth: 1, borderColor: "#DEE2E6", borderRadius: 10, paddingHorizontal: 12, paddingVertical: 11, marginTop: 12, color: "#212529", backgroundColor: "#F8F9FA" },
  darkInput: { backgroundColor: "#151718", borderColor: "#343A40", color: "#ECEDEE" },
  addressInput: { minHeight: 76, textAlignVertical: "top" },
  addressStatus: { width: "100%", color: "#495057", fontSize: 13, marginTop: 12 },
  orderItemCard: { width: "100%", backgroundColor: "#F8F9FA", borderRadius: 12, padding: 14, marginBottom: 10 },
  orderHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 4 },
  orderId: { fontSize: 13, fontWeight: "800", color: "#FF6B35" },
  orderDateText: { fontSize: 11, color: "#868E96", marginBottom: 8 },
  statusBadge: { backgroundColor: "rgba(255, 107, 53, 0.12)", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  statusText: { fontSize: 10, fontWeight: "700", color: "#FF6B35" },
  orderDetailsText: { fontSize: 13, fontWeight: "600", color: "#212529" },
  orderTotalDivider: { height: 1, backgroundColor: "#E9ECEF", marginVertical: 8 },
  orderTotalRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  orderTotalLabel: { fontSize: 12, color: "#868E96" },
  orderPriceText: { fontSize: 14, fontWeight: "800", color: "#FF6B35" },
  emptyOrdersView: { alignItems: "center", paddingVertical: 24 },
  emptyOrdersText: { fontSize: 13, color: "#868E96", marginTop: 8 },
  modalCloseButton: { marginTop: 14, backgroundColor: "#FF6B35", borderRadius: 10, paddingVertical: 11, alignItems: "center" },
  modalCloseText: { color: "#FFFFFF", fontWeight: "700" },
  cancelButton: { paddingVertical: 12, marginTop: 4 },
